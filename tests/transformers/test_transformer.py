...
class TestETLMethods(unittest.TestCase):
    ...
    def test_extract_no_files(self):
        ...
        """
        #expected results is empty data frame
        # test init
        extract_date = '2300-01-02'
        extract_date_list = []
    ...
    def test_extract_files(self):
        ...
        with patch.object(MetaProcess,"return_date_list",return_value=[extract_date,extract_date_list]):
            ...
            df_return = etl.extract()
        #run tests
        self.assertTrue(df_return.equals(df_exp))
    ...
    def test_transform_report1_emptydf(self):
        ...
        with patch.object(MetaProcess,"return_date_list",return_value=[extract_date,extract_date_list]):
            ...
            with self.assertLogs() as logm:
                df_return = etl.transform_report1(df_in)
    ...
    def test_transform_report1_ok(self):
        ...
        """
        #expected results 
        log1_exp = "Starting trasformation..."
        log2_exp = "Applying transformations to data finished."
        df_exp = self.df_report
        # test init
        extract_date = '2021-04-17'
        extract_date_list = ['2021-04-16', '2021-04-17', '2021-04-18', '2021-04-19', '2021-04-20']
        df_in = self.df_src.loc[1:8].reset_index(drop=True)
        # method execution
        with patch.object(MetaProcess,"return_date_list",return_value=[extract_date,extract_date_list]):
            # creating ETL class instance
            etl = ETL(self.s3_bucket_src,self.s3_bucket_trg,
    ...
    def test_etl(self):
        ...
        """
        # Expected results
        log1_exp = 'ETL Started'
        log2_exp = 'ETL finished'
        df_exp = self.df_report
        ...
        self.assertEqual(return_exp,return_val)
        # Cleanup after test
