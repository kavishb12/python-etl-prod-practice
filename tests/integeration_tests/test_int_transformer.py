""" IntegerationTestXetraETLMethods"""
...
class IntTestETLMethods(unittest.TestCase):
    """
    Inegeration Testing the XetraETL class.
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'src-bucket-test-data-pipeline'
        self.s3_bucket_name_trg = 'trg-bucket-test-data-pipeline'
        self.meta_key = 'meta_key'
        # Creating the source and target bucket on the s3
